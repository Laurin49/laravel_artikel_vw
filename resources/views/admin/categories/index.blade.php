    ...
    <div class="container max-w-6xl mx-auto mt-20">
        <div class="mb-4">
            <div class="flex justify-end">
                <a href="{{ route('admin.categories.create')}}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">
                    Create Category
                </a>
            </div>
        </div>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                    <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('{{ trans('Wollen Sie wirklich löschen ? ') }}');">
                                        @csrf
                                        @method('DELETE')
